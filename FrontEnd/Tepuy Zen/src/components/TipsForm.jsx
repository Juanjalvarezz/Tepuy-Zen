...
const TipsForm = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    try {
      const res = await axios.post('http://localhost:3000/api/tips', formData);
    ...
    <div className="w-4/5 mx-auto flex justify-center items-center">
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-5 p-5  rounded-lg bg-[#77BFA3]">
        ...
        />
          ...
          <div className="mb-3">
          <h1 className='md:col-span-2 text-center -mt-2 mb-1'>Agrega una Imagen para mostrar los Tips:</h1>
